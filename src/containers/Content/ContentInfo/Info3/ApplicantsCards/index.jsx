...
const ApplicantsCards = () => {
  ...
  return (
    <div className="grid grid-cols-1 grid-rows-3 gap-y-6">
      <div className="article__how__card row-span-1 grid grid-cols-4 w-[95%] h-[90%] mx-auto">
        <div className="flex flex-col gap-4 col-span-3">
          <h6>{articleTitle}</h6>
          <p>{articleContent}</p>
        </div>
        <div className="col-span-1 self-start justify-self-end">
      ...
      <div className="grid grid-cols-10 gap-x-3 row-span-2">
        <div className="applicants__card col-span-6 grid grid-cols-1 grid-rows-5 gap-y-4 h-[90%]">
          ...
          <ul className="row-span-5 grid grid-cols-1 gap-y-5">
            {items.map(({ applicantImg, member, stars }, index) => (
              <li className="grid grid-cols-7 gap-x-6 h-10" key={idGenerator()}>
                <div
                ...
                <div className="col-span-2 grid grid-cols-2 h-6 self-center">
                  <img className="col-span1" src={starImg} alt="Star Symbol" />
        ...
        <div className="candidate__card col-span-4 grid grid-cols-1 grid-rows-5 h-[89%] self-end">
          ...
          <div className="grid grid-cols-2 justify-items-center row-span-1">
            ...
            <div className="col-span-1 row-span-1 grid grid-cols-2 self-center justify-self-end">
              <img src={starImg} alt="Star Symbol" />
